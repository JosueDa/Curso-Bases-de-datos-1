...
<?php
    ...
    if(isset($_POST["agregar"])){
        $stmt3 = $pdo->prepare('SELECT COUNT(*) from restaurante.favoritos WHERE tipo="top"');
        $stmt3->execute();
    ...
    }else{header("location: updateTop.php?E=1");}
    };
    ?>
    ...
    <?php
                if(isset($_GET["E"])){
                    ...
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                      ...
                      Solo puedes tener un máximo de 12 platillos
                  </div>';
                }; ?>
