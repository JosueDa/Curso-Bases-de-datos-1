    ...
    <h2>Listado de productos</h2>
      <div class="ingredientes">
          <form action="" >
            ...
            <a class="btn btn-secondary input" href="agregar2.php"> Agregar</a>
          </form>
      </div>
      <table class="table">
          ...
          <tbody>
              ...
              <td><a href="update2.php?id=<?php echo $fila['id_producto']; ?>"  class="btn btn-block btn-sm btn-outline-info" >Update</a></td>
					    <td><a href="delete2.php?id=<?php echo $fila['id_producto']; ?>" class="btn btn-block btn-sm btn-outline-danger">Delete</a></td>
            </tr>
            <?php endforeach ?>
          </tbody>
        </table>
